  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[600px] h-[calc(100vh-140px)]">
      ...
      <div className="col-span-1 lg:col-span-4 flex flex-col h-full gap-4">
        {/* Mock AI Video Frame */}
        <HoverCard>
          <Card className="shadow-none border-0 overflow-hidden shrink-0 relative bg-black/5 dark:bg-black/40">
        ...
        {/* Current Question */}
        <HoverCard className="flex-1 flex flex-col min-h-0">
          <Card className="flex-1 shadow-none border-0 bg-transparent flex flex-col overflow-hidden h-full">
      ...
      <div className="col-span-1 lg:col-span-5 flex flex-col h-full">
        <HoverCard className="flex-1 flex flex-col min-h-0">
          <Card className="flex-1 shadow-none border-0 bg-transparent flex flex-col overflow-hidden relative h-full">
      ...
      <div className="col-span-1 lg:col-span-3 flex flex-col h-full gap-4">
        ...
        <HoverCard className="flex-1 flex flex-col min-h-0">
          <Card className="flex-1 shadow-none border-0 bg-transparent flex flex-col h-full">
            <CardHeader className="py-4 border-b bg-muted/30">
            ...
            <CardContent className="p-4 flex-1 flex flex-col">
              ...
              <div className="mt-auto pt-4 border-t border-border/60 space-y-3">
                ...
                <Button 
                  variant="destructive" 
                  className="w-full font-bold shadow-sm hover:scale-105 hover:shadow-lg transition-all"
